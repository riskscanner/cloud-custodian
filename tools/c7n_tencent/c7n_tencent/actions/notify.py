...
from c7n_tencent.provider import resources as tencent_resources
...
class Notify(BaseNotify):
    ...
    # Methods to handle TENCENT Pub Sub topic publishing
    def publish_message(self, message, client):
        """Publish message to a TENCENT pub/sub topic
         """
...
tencent_resources.subscribe(Notify.register_resource)
