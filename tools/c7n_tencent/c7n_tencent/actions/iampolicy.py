...
class SetIamPolicy(MethodAction):
    """ Sets IAM policy. It works with bindings only.
        ...
        both `setIamPolicy` and `getIamPolicy` methods (such as tencent.spanner-database-instance).
        ...
        .. code-block:: yaml
            ...
            policies:
              - name: tencent-spanner-instance-set-iam-policy
                resource: tencent.spanner-instance
                actions:
                  - type: set-iam-policy
                    add-bindings:
                      - members:
